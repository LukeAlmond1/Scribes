...
div
    ...
    section(class="bg-blog-cover bg-cover flex h-48 items-end justify-center mb-16 w-full")
        //- Input field
        //- ---------------------------------------------------------------------------------------
        aside(class="bg-white border-teal-700 drop-shadow-2xl flex gap-4 h-22 items-center -mb-8 rounded-md w-10/12 xl:w-3/6")
    ...
    //- Search summary
    //- -------------------------------------------------------------------------------------------
    section(class="flex flex-col gap-2 items-center justify-center mx-auto mb-6 w-11/12")
    ...
    //- Banner
    //- -------------------------------------------------------------------------------------------
    section(class="flex justify-between mx-auto w-11/12")
        //- Sort by
        //- ---------------------------------------------------------------------------------------
        aside(class="border-2 border-gray-100 cursor-pointer flex gap-6 items-center px-4 py-3 rounded-md text-gray-500")
            p() Popular
        ...
        aside(class="flex gap-6")
            a(
                ...
                :title="item.tag"
                :key="index"
                class="bg-gray-50 font-semibold flex items-center px-4 rounded-md text-gray-800"
